...
═══════════════════════════════════
محمود هو المدخل الوحيد للبيانات - يسجل حركات أمناء العهدة (سارة، مصطفى، ام سيليا)

[مهم جداً] التفريق بين إيداع وصرف:
- "صرف/صرفت من العهدة" أو "من العهده" = صرف_من_عهدة (خصم من رصيد العهدة)
- "حولت عهدة" أو "عهدة لـ" = إيداع_عهدة (إضافة لرصيد العهدة)

═══════════════════════════════════
أمثلة إيداع_عهدة (إضافة فلوس للعهدة):
═══════════════════════════════════
- "حولت لسارة 10000 عهدة" ← إيداع_عهدة، جهة: سارة
- "حولت لمصطفى 3000 عهده" ← إيداع_عهدة، جهة: مصطفى
- "عهدة سارة 10000" ← إيداع_عهدة، جهة: سارة
- "حولت لام سيليا 5000 عهدة" ← إيداع_عهدة، جهة: ام_سيليا
- "حولت لمراتي 5000" ← إيداع_عهدة، جهة: ام_سيليا (الزوجة أمينة عهدة)

═══════════════════════════════════
أمثلة صرف_من_عهدة (خصم فلوس من العهدة):
═══════════════════════════════════
*** محمود يسجل ما صرفه أمناء العهدة ***
- "سارة صرفت من العهدة 500 جمعية" ← صرف_من_عهدة، جهة: سارة، تصنيف: جمعية
- "مصطفي صرف من العهده لنفسه 1000" ← صرف_من_عهدة، جهة: مصطفى، تصنيف: مساعدة مصطفى
- "مصطفي صرف من العهده لهاجر 2000" ← صرف_من_عهدة، جهة: مصطفى، تصنيف: مساعدة هاجر
- "ام سيليا صرفت من العهده 3000" ← صرف_من_عهدة، جهة: ام_سيليا
- "ام سيليا دفعت جمعية 1500 من العهده" ← صرف_من_عهدة، جهة: ام_سيليا، تصنيف: جمعية
- "سارة أعطت محمد 1000 من العهدة" ← صرف_من_عهدة، جهة: سارة، تصنيف: مساعدة محمد

═══════════════════════════════════
أمثلة تحويل عادي (بدون كلمة عهدة):
- "حولت لسارة 10000 جنيه" ← تحويل (ليس عهدة) - سارة أخت وليست أمينة عهدة في هذا السياق
- "حولت للأهل 5000" ← تحويل

[مهم جداً] التحويل لمراتي/زوجتي/ام سيليا = إيداع_عهدة دائماً:
- "حولت لمراتي 5000" ← إيداع_عهدة (لأن الزوجة أمينة عهدة)
- "حولت لزوجتي 3000 بسعر 12" ← إيداع_عهدة
- "حولت لام سيليا 4000" ← إيداع_عهدة
...
← نوع: إيداع_عهدة، مبلغ: 3000، عملة: ريال، سعر_الصرف: 12، مبلغ_مستلم: 36000، جهة: ام_سيليا
...
← معاملة واحدة فقط (لأن التفاصيل تُدخل لاحقاً من قِبَل الزوجة):
نوع: إيداع_عهدة، مبلغ: 4000، عملة: جنيه، جهة: ام_سيليا، وصف: "عهدة ام سيليا (منهم 1500 جمعية والباقي مصروفها)"
