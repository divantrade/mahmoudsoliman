...
const FAMILY_CONTACTS = [
  ...
  },
  {
    ...
    اسم: 'ام سيليا',
    علاقة: 'زوجة',
    اسماء_بديلة: ['ام سيليا', 'أم سيليا', 'Om Celia', 'om celia', 'ام سليا', 'أم سليا', 'مراتي', 'زوجتي', 'سارة مراتي', 'ساره مراتي'],
    عملة: 'EGP',
    امين_عهدة: true  // ⭐ ام سيليا أمينة عهدة
  }
];
...
- زوجته ام سيليا (* أمينة عهدة): "ام سيليا"، "أم سيليا"، "Om Celia"، "سارة مراتي" ← الكود: ام_سيليا
