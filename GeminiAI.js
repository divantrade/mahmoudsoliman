...
═══════════════════════════════════════════════════════════
{
  ...
  "معاملات": [
    {
      "طبيعة": "إيراد/مصروف/تحويل/استثمار",
      "تصنيف": "من البنود المتاحة فقط!",
      "بند": "من البنود المتاحة فقط!",
      "مبلغ": رقم,
      "عملة": "ريال/جنيه/دولار",
      "من_حساب": "كود الحساب (مثل MOSTAFA, WIFE, MAIN)",
      "إلى_حساب": "كود الحساب أو فارغ",
      "وصف": "وصف الحركة"
    }
  ],
  "رسالة": "رسالة تأكيد"
...
⚠️ قواعد مهمة جداً
═══════════════════════════════════════════════════════════
1. ⭐ "من X لـ Y" = تحويل من حساب X إلى حساب Y (وليس من MAIN!)
2. مراتي/زوجتي/WIFE = حساب WIFE
3. استخدم فقط التصنيفات والبنود المذكورة في القائمة أعلاه
4. لا تخترع تصنيفات جديدة - استخدم الأقرب من الموجود
5. العملة الافتراضية = ريال، إلا إذا ذُكر "جنيه" أو "دولار"
6. الحساب الافتراضي = MAIN فقط إذا لم يُذكر حساب آخر
7. "منهم" أو "والباقي" = قسّم لعدة حركات
8. صرف من عهدة = من_حساب = كود العهدة
